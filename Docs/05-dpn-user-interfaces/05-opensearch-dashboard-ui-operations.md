...
- [2. OpenSearch in the DPN Project](#2-opensearch-in-the-dpn-project)
  - [What DPN monitors](#what-dpn-monitors)
  - [How data reaches OpenSearch](#how-data-reaches-opensearch)
  - [Simple data flow](#simple-data-flow)
- [3. Accessing the Dashboard](#3-accessing-the-dashboard)
- [4. Dashboard Controls](#4-dashboard-controls)
  - [Time picker](#time-picker)
  - [Auto-refresh](#auto-refresh)
  - [Filter bar](#filter-bar)
  - [KQL query bar](#kql-query-bar)
  - [Panels at a glance](#panels-at-a-glance)
...
- [6. Saved Searches](#6-saved-searches)
  ...
  - [Log View – Filterable by Severity & Date](#log-view--filterable-by-severity--date)
  - [Pipeline Failures – Diagnostics](#pipeline-failures--diagnostics)
- [7. Querying and Filtering](#7-querying-and-filtering)
  - [Example queries](#example-queries)
  - [Filter bar tips](#filter-bar-tips)
- [8. Troubleshooting Common Scenarios](#8-troubleshooting-common-scenarios)
  - ["The dashboard shows no data — all panels are blank"](#the-dashboard-shows-no-data--all-panels-are-blank)
  - ["A component row is showing red or amber in Panel 1"](#a-component-row-is-showing-red-or-amber-in-panel-1)
