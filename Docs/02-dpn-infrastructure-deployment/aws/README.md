...
This folder provides a common, implementation-agnostic guide to deploy DPN-style infrastructure on AWS using OpenTofu.
...
- Replace placeholder values (for example `<env>`, `<region>`, `<account-id>`) before executing commands.
