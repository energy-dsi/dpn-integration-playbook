...
- [Installation Steps](#installation-steps)
  - [1. Create the Corrected Environment Config Files](#step-1--create-the-corrected-environment-config-files)
  - [2. Provision the Namespace and Registry Access](#step-2--provision-the-namespace-and-registry-access)
  - [3. Remediate the Committed Dashboard Credential](#step-3--remediate-the-committed-dashboard-credential)
  - [4. Configure Environment Approval Gates](#step-4--configure-environment-approval-gates)
  - [5. Provision the Thanos Object Storage Secret](#step-5--provision-the-thanos-object-storage-secret)
  - [6. Configure Alerting](#step-6--configure-alerting)
  - [7. Run `monitoring-master-cd.yaml`](#step-7--run-monitoring-master-cdyaml)
  - [8. Approve Each Stage's Deployment Gate](#step-8--approve-each-stages-deployment-gate)
  - [9. Verify the HPA on the OTEL Collector](#step-9--verify-the-hpa-on-the-otel-collector)
  - [10. Verify the Deployment](#step-10--verify-the-deployment)
